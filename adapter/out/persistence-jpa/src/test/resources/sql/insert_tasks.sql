...
values (now(), '2060-11-20', 1, 'Task 1', 'Task 1 Description', 'TO_DO',
...
values (now(), 2, 'Task 2', 'Task 2 Description', 'TO_DO',
(select id from projects where title = 'Project'),
(select id from users where email = 'jdoe@mail.com'),
(select id from users where email = 'bbeggins@mail.com'));

insert into tasks (created_at, number, title, description, status, project_id, owner_id, assignee_id)
values (now(), 3, 'Task 3', 'Task 3 Description', 'TO_DO',
(select id from projects where title = 'Project'),
(select id from users where email = 'jdoe@mail.com'),
(select id from users where email = 'bbeggins@mail.com'));

insert into tasks (created_at, number, title, description, status, project_id, owner_id, assignee_id)
values (now(), 4, 'Task 4', 'Task 4 Description', 'TO_DO',
(select id from projects where title = 'Project'),
(select id from users where email = 'jdoe@mail.com'),
(select id from users where email = 'jsnow@mail.com'));
...
insert into tasks (created_at, number, title, description, status, project_id, owner_id, assignee_id)
values (now(), 5, 'Task 5', 'Task 5 Description', 'TO_DO',
(select id from projects where title = 'Project'),
(select id from users where email = 'jdoe@mail.com'),
(select id from users where email = 'jsnow@mail.com'));
...
insert into tasks (created_at, number, title, description, status, project_id, owner_id, assignee_id)
values (now(), 6, 'Task 6', 'Task 6 Description', 'TO_DO',
(select id from projects where title = 'Project'),
(select id from users where email = 'jdoe@mail.com'),
(select id from users where email = 'jsnow@mail.com'));

insert into tasks (created_at, number, title, description, status, project_id, owner_id, assignee_id)
values (now(), 7, 'Task 7', 'Task 7 Description', 'IN_PROGRESS',
(select id from projects where title = 'Project'),
(select id from users where email = 'jdoe@mail.com'),
(select id from users where email = 'jsnow@mail.com'));

insert into tasks (created_at, number, title, description, status, project_id, owner_id, assignee_id)
values (now(), 8, 'Task 8', 'Task 8 Description', 'IN_PROGRESS',
(select id from projects where title = 'Project'),
(select id from users where email = 'jdoe@mail.com'),
(select id from users where email = 'jsnow@mail.com'));

insert into tasks (created_at, number, title, description, status, project_id, owner_id, assignee_id)
values (now(), 9, 'Task 9', 'Task 9 Description', 'IN_PROGRESS',
(select id from projects where title = 'Project'),
(select id from users where email = 'jdoe@mail.com'),
(select id from users where email = 'jsnow@mail.com'));

insert into tasks (created_at, number, title, description, status, project_id, owner_id, assignee_id)
values (now(), 10, 'Task 10', 'Task 10 Description', 'IN_PROGRESS',
(select id from projects where title = 'Project'),
(select id from users where email = 'jdoe@mail.com'),
(select id from users where email = 'jsnow@mail.com'));

insert into tasks (created_at, number, title, description, status, project_id, owner_id, assignee_id)
values (now(), 11, 'Task 11', 'Task 11 Description', 'IN_PROGRESS',
(select id from projects where title = 'Project'),
(select id from users where email = 'jdoe@mail.com'),
(select id from users where email = 'jsnow@mail.com'));

insert into tasks (created_at, number, title, description, status, project_id, owner_id, assignee_id)
values (now(), 12, 'Task 12', 'Task 12 Description', 'IN_PROGRESS',
(select id from projects where title = 'Project'),
(select id from users where email = 'jdoe@mail.com'),
(select id from users where email = 'jsnow@mail.com'));

insert into tasks (created_at, number, title, description, status, project_id, owner_id, assignee_id)
values (now(), 13, 'Task 13', 'Task 13 Description', 'IN_PROGRESS',
(select id from projects where title = 'Project'),
(select id from users where email = 'jdoe@mail.com'),
(select id from users where email = 'bbeggins@mail.com'));

insert into tasks (created_at, number, title, description, status, project_id, owner_id, assignee_id)
values (now(), 14, 'Task 14', 'Task 14 Description', 'IN_PROGRESS',
(select id from projects where title = 'Project'),
(select id from users where email = 'jdoe@mail.com'),
(select id from users where email = 'bbeggins@mail.com'));

insert into tasks (created_at, number, title, description, status, project_id, owner_id, assignee_id)
values (now(), 15, 'Task 15', 'Task 15 Description', 'DONE',
(select id from projects where title = 'Project'),
(select id from users where email = 'jdoe@mail.com'),
(select id from users where email = 'jsnow@mail.com'));

insert into tasks (created_at, number, title, description, status, project_id, owner_id, assignee_id)
values (now(), 16, 'Task 16', 'Task 16 Description', 'DONE',
(select id from projects where title = 'Project'),
(select id from users where email = 'jdoe@mail.com'),
(select id from users where email = 'jsnow@mail.com'));

insert into tasks (created_at, number, title, description, status, project_id, owner_id, assignee_id)
values (now(), 17, 'Task 17', 'Task 17 Description', 'DONE',
(select id from projects where title = 'Project'),
(select id from users where email = 'jdoe@mail.com'),
(select id from users where email = 'jsnow@mail.com'));

insert into tasks (created_at, number, title, description, status, project_id, owner_id, assignee_id)
values (now(), 18, 'Task 18', 'Task 18 Description', 'DONE',
(select id from projects where title = 'Project'),
(select id from users where email = 'jdoe@mail.com'),
(select id from users where email = 'jsnow@mail.com'));

insert into tasks (created_at, number, title, description, status, project_id, owner_id, assignee_id)
values (now(), 19, 'Task 19', 'Task 19 Description', 'DONE',
(select id from projects where title = 'Project'),
(select id from users where email = 'jdoe@mail.com'),
(select id from users where email = 'bbeggins@mail.com'));

insert into tasks (created_at, number, title, description, status, project_id, owner_id, assignee_id)
values (now(), 20, 'Task 20', 'Task 20 Description', 'DONE',
(select id from projects where title = 'Project'),
(select id from users where email = 'jdoe@mail.com'),
(select id from users where email = 'bbeggins@mail.com'));